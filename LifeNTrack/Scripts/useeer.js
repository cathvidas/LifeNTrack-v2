...
document.querySelectorAll('.event-button').forEach(function (button) {
    button.addEventListener('click', function () {
        ...
        document.querySelector('#set-activity-modal input[name="activityId"]').value = eventID;
        document.querySelector('#delete-activity-modal input[name="activityId"]').value = eventID;

        document.querySelector('#edit-activity-modal input[name="activityId"]').value = eventID;
